...
$commands = @(
    ...
    "cd /home/ubuntu",
    "if [ ! -d /home/ubuntu/akeneo-pim ]; then sudo -u ""$BOOTSTRAP_USER"" -H git clone https://github.com/EpicGlobal/Akeneo.git /home/ubuntu/akeneo-pim; fi",
    "chown -R ""$BOOTSTRAP_USER"":""$BOOTSTRAP_USER"" /home/ubuntu/akeneo-pim || true",
    "sudo -u ""$BOOTSTRAP_USER"" -H git -C /home/ubuntu/akeneo-pim fetch origin master",
    "sudo -u ""$BOOTSTRAP_USER"" -H git -C /home/ubuntu/akeneo-pim checkout master",
    "sudo -u ""$BOOTSTRAP_USER"" -H git -C /home/ubuntu/akeneo-pim pull --ff-only origin master",
