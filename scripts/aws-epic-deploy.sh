...
OPERATOR_CONTROL_PLANE_DB_HOST_VALUE="${OPERATOR_CONTROL_PLANE_DB_HOST_VALUE:-mysql}"
OPERATOR_CONTROL_PLANE_DB_PORT_VALUE="${OPERATOR_CONTROL_PLANE_DB_PORT_VALUE:-3306}"
OPERATOR_CONTROL_PLANE_DB_USER_VALUE="${OPERATOR_CONTROL_PLANE_DB_USER_VALUE:-akeneo_pim}"
OPERATOR_CONTROL_PLANE_DB_NAME_VALUE="${OPERATOR_CONTROL_PLANE_DB_NAME_VALUE:-akeneo_pim}"
OPERATOR_CONTROL_PLANE_DB_TABLE_PREFIX_VALUE="${OPERATOR_CONTROL_PLANE_DB_TABLE_PREFIX_VALUE:-operator_control_plane_}"
OPERATOR_CONTROL_PLANE_DB_CREATE_IF_MISSING_VALUE="${OPERATOR_CONTROL_PLANE_DB_CREATE_IF_MISSING_VALUE:-0}"
LOCAL_PIM_HEALTH_URI="${LOCAL_PIM_HEALTH_URI:-http://127.0.0.1/}"
LOCAL_RESOURCE_SPACE_HEALTH_URI="${LOCAL_RESOURCE_SPACE_HEALTH_URI:-http://127.0.0.1/assets/}"
...
set_env_value "OPERATOR_CONTROL_PLANE_DB_HOST" "$OPERATOR_CONTROL_PLANE_DB_HOST_VALUE"
set_env_value "OPERATOR_CONTROL_PLANE_DB_PORT" "$OPERATOR_CONTROL_PLANE_DB_PORT_VALUE"
set_env_value "OPERATOR_CONTROL_PLANE_DB_USER" "$OPERATOR_CONTROL_PLANE_DB_USER_VALUE"
set_env_value "OPERATOR_CONTROL_PLANE_DB_PASSWORD" "${OPERATOR_CONTROL_PLANE_DB_PASSWORD_VALUE:-${APP_DATABASE_PASSWORD_VALUE:-akeneo_pim}}"
set_env_value "OPERATOR_CONTROL_PLANE_DB_NAME" "$OPERATOR_CONTROL_PLANE_DB_NAME_VALUE"
set_env_value "OPERATOR_CONTROL_PLANE_DB_TABLE_PREFIX" "$OPERATOR_CONTROL_PLANE_DB_TABLE_PREFIX_VALUE"
set_env_value "OPERATOR_CONTROL_PLANE_DB_CREATE_IF_MISSING" "$OPERATOR_CONTROL_PLANE_DB_CREATE_IF_MISSING_VALUE"
